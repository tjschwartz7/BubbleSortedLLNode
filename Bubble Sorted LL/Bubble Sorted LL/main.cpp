...
//It then sorts this input using bubble sort, arguably one of the slowest sorting algorithms (with the exception of some particularly exceptional exceptions like bogosort)
